...
export default function BookedAccommodationsPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto py-8 px-4">
      ...
      <p className="text-muted-foreground mb-6">All accommodations you have successfully booked (confirmed bookings only).</p>
      {user ? (
        <BookingsList userId={user.id} status="confirmed" debug label="Booked" />
      ) : (
